...
class UserProxyAPIAgent(UserProxyAgent):
    def __init__(self, *args, **kwargs):
        super(UserProxyAPIAgent, self).__init__(*args, **kwargs)
        ...
        self.register_reply([Agent, None], UserProxyAPIAgent.a_check_termination_and_human_reply)
